...
import ImportExportQuotationStatus from './components/ImportExportQuotationStatus.jsx'
import './App.css'
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div>
        ...
        {currentView === 'approval' && <ImportExportQuotationStatus currentUser={currentUser} />}
        {currentView === 'booking' && (
